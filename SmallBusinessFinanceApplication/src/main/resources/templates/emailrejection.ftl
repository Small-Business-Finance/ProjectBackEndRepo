...
this is to advise you that we will not be able to extend credit to you at this time.<br><pre></pre>

After a thorough review of your application and the supporting documents you supplied,<br><pre></pre> 

we have concluded that your current financial situation is not meeting our set conditions.<br><pre></pre>
